...
export const LampContainer = ({
  ...
  return (
    ...
    >
        ...
        <div className="invisible md:visible lg:visible relative flex w-full flex-1 scale-y-10 items-center justify-center isolate z-0 ">
          <motion.div
            initial={{ opacity: 0.10, width: "15rem" }}
            whileInView={{ opacity: 0.20, width: "30rem" }}
            transition={{
              delay: 0.3,
              duration: 0.8,
              ease: "easeInOut",
      ...
      <div className="relative z-50 flex -translate-y-80 flex-col items-center px-5 mt-5">
        {children}
      </div>
    </div>
  );
